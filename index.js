...
var Slot = function(options, canvasNode) {
    ...
    var defaultOptions = {
        ...
        soundWinUrl: "../audio/klubnichki.mp3",
        soundReelStopUrl: "../audio/mechanical_analog_ticking.mp3",
        reelCount: 3,           // количество барабанов
        reelBorderWidth: 6,
        reelOffset: 30,         // расстояния между барабанами
        symbolSize: 130,        // размер тайла иконки
        maxReelSpeed: 100,       // максимальная скорость раскрутки барабанов
        minStopDelay: 400,      // минимальная задержка остановки барабана, мс
        ...
        animateWinReelLightOffCount: 12, // сколько раз мигать во время анимации победы
        reelAreaLeft: 32,
        reelAreaTop: 32,
        reelAreaHeight: 190,
        displays: {
